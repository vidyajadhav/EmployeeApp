...
<div class="smart-green">
	...
	<br>
	<form method="post" action="<%=request.getContextPath()%>/edit.htm">
		<label>CODE:</label><input type="text" name="code" required="required" value="<%=request.getParameter("code") %>" readonly/>
		<br/>
		<label>NAME:</label> <input type="text" name="name" required="required" value="<%=request.getParameter("name") %>" pattern="[A-Za-z]+"/>
		<br/>
		<label>CITY:</label> <input type="text" name="city" required="required" value="<%=request.getParameter("city") %>" pattern="[A-Za-z]+"/>
		<br/>
